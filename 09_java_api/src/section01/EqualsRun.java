...
public class EqualsRun {
	public static void main(String[] args) {
		...
		Book book3 = book1;
		System.out.println(book1 == book3);																// 저장된 주소 같음
		System.out.println("book1 == book2 : " + (book1 == book2));				// 저장된 주소 다름 (서로 다른 객체 참조)
		System.out.println("book1.equals(book2) : " + book1.equals(book2));				// 오버라이딩 후 (필드 값 비교)
