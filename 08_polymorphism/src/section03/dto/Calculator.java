...
/* 인터페이스 (interface)
: Java에서는 객체 간의 접점을 만드는 용도로 사용

ex)
	UI (User Interface) : 화면을 통해서 프로그램과 사용자가 접촉함
[효과]
	1) 클래스/객체 간의 점점을 만들 수 있다
...
[작성법]
	...
	3) default 메서드 작성 가능 (오버라이딩 가능)
		default void 메서드명(){}
[사용법]
	1) 해당 인터페이스를 상속받을 클래스에 implements 키워드를 작성 (implements : 구현하다)
...
/** Calculator 인터페이스
 * : 객체 생성 용도 X, 클래스/객체 간의 접점 용도 O
 */
public interface Calculator {
	// 필드는 public static final만 작성 가능
	public static final int MAX_NUM = 1_000_000_000;
	int MIN_NUM = -1_000_000_000;														// public static final 생략 가능. 컴파일러가 자동 추가
